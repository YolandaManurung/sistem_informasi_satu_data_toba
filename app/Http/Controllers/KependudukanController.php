...
class KependudukanController extends Controller
{
    ...
    public function index1(Request $request)
    {
        ...
        $tbl21a=DB::table('kependudukan_jumlah_penduduk')->where('status', '=', 'Accepted')->get();
        $jumlah_laki_laki=0;
        ...
        $data21 = [];
        $data21a = [];
        foreach ($tbl21a as $tabel21a){
            $categories21[] = $tabel21a->kecamatan;
            $data21[] = $tabel21a->laki_laki;
            $data21a[] = $tabel21a->perempuan;
        }
       ...
       //kesehatan jumlah dokter
        ...
        ,'data39','data39a','data39b','data40','data40a','data40b','data36','data36a','data36b','jumlah_panjang_jalan','tbl44c','data43a','data43b','data44c','data44a',
            ...
            'jumlah_pengguna_dana_desa', 'tabel2','tbl21a'));
        }
        ...
        public function index2(Request $request)
    {
        ...
        //kependudukan jumlah akta 
        $tbl22=DB::table('kependudukan_jumlah_akta')->paginate(10);
        $tbl22a=DB::table('kependudukan_jumlah_akta')->where('status', '=', 'Accepted')->get();
        $jumlah_kelahiran=0;
        foreach ($tbl22 as $tabel22){
            $jumlah_kelahiran+=$tabel22->akta_kelahiran;
        }
        ...
        $data22b = [];
        $data22c = [];
        foreach ($tbl22a as $tabel22a){
            $categories22[] = $tabel22a->kecamatan;
            $data22[] = $tabel22a->akta_kelahiran;
            $data22a[] = $tabel22a->akta_perkawinan;
            $data22b[] = $tabel22a->akta_perceraian;
            $data22c[] = $tabel22a->yang_memiliki_ektp; 
        }
       ...
       //kesehatan jumlah dokter
        ...
        ,'data39','data39a','data39b','data40','data40a','data40b','data36','data36a','data36b','jumlah_panjang_jalan','tbl44c','data43a','data43b','data44c','data44a',
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl22a'));
        }
        ...
        public function index3(Request $request)
    {
        ...
        //tenaga kerja
        $tbl23=DB::table('kependudukan_tenaga_kerja')->paginate(10);
        $tbl23a=DB::table('kependudukan_tenaga_kerja')->where('status', '=', 'Accepted')->get();
        $categories23 = [];
        $data23 = [];
        $data23a = [];
        $data23b = [];
        ...
        $data23e = [];
        $data23f = [];
        foreach ($tbl23a as $tabel23a){
            $categories23[] = $tabel23a->kelompok_umur;
            $data23[] = $tabel23a->bekerja;
            $data23a[] = $tabel23a->pencari_kerja;
            $data23b[] = $tabel23a->angkatan_kerja;
            $data23c[] = $tabel23a->bukan_angkatan_kerja; 
            $data23d[] = $tabel23a->tenaga_kerja; 
            $data23e[] = $tabel23a->APAK; 
            $data23f[] = $tabel23a->pengangguran_terbuka; 
        }
       ...
       //kesehatan jumlah dokter
        ...
        ,'data39','data39a','data39b','data40','data40a','data40b','data36','data36a','data36b','jumlah_panjang_jalan','tbl44c','data43a','data43b','data44c','data44a',
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl23a', 'tabel23a'));
        }
