...
class PendidikanController extends Controller
{
    ...
    public function exportpdf39()
    {
        $pendidikanp = pendidikanpaud::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pendidikan_paud_pdf', ['pendidikanp' => $pendidikanp]);
    ...
    public function update39(Request $request, $id){
        $this->validate($request,[ 
            ...
            'negeri'=>'required',
            'swasta'=>'required',
            'Madrasah_Ibtidaiyah_Tsanawiyah'=>'required',
            'tahun'=>'required',
            'status'=>'required',
        ]);
        $input_data=$request->all();
        pendidikanpaud::where('id',$id)->update([
            'kecamatan'=>$input_data['kecamatan'],
            'jumlah_paud'=>$input_data['jumlah_paud'],
            'jumlah_guru'=>$input_data['jumlah_guru'],
            'jumlah_murid'=>$input_data['jumlah_murid'],
            'negeri'=>$input_data['negeri'],
            'swasta'=>$input_data['swasta'],
            'Madrasah_Ibtidaiyah_Tsanawiyah'=>$input_data['Madrasah_Ibtidaiyah_Tsanawiyah'],
            'tahun'=>$input_data['tahun'],
            'status'=>$input_data['status']]);
        return redirect('/pendidikanpaud')->with('message','Update already Update!');
    }

public function hapus39($id)
{
	DB::table('pendidikan_paud')->where('id',$id)->delete();
	return redirect('/pendidikanpaud');
}

public function formulir7(){
            return view("pages.formulir-pendidikan-paud");
}

    public function tambah7(Request $request)
    {
        pendidikanpaud::create(['jumlah_paud'=> $request->jumlah_paud, 'kecamatan' => $request->kecamatan,
    ...
    public function exportpdf40()
    {
        $pendidikans = pendidikansd::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pendidikan_sd_pdf', ['pendidikans' => $pendidikans]);
        return $pdf->download('pendidikansd.pdf');
    }

public function hapus40($id)
{
	DB::table('pendidikan_sd')->where('id',$id)->delete();
...
public function update40(Request $request, $id){
        ...
        $input_data=$request->all();
        pendidikansd::where('id',$id)->update([
            'kecamatan'=>$input_data['kecamatan'],
            'jumlah_sd'=>$input_data['jumlah_sd'],
            'jumlah_guru'=>$input_data['jumlah_guru'],
            'jumlah_murid'=>$input_data['jumlah_murid'],
            'negeri'=>$input_data['negeri'],
            'swasta'=>$input_data['swasta'],
    ...
    {
        pendidikansltp::create(['jumlah_sltp'=> $request->jumlah_sltp, 'kecamatan' => $request->kecamatan,
        'jumlah_guru' => $request->jumlah_guru, 'jumlah_murid'=>$request->jumlah_murid,'negeri'=>$request->negeri
        ,'swasta'=>$request->swasta,'Madrasah_Ibtidaiyah_Tsanawiyah'=>$request->Madrasah_Ibtidaiyah_Tsanawiyah,
        'tahun'=>$request->tahun]);
        return back()->withStatus(__('Data Berhasil Disimpan'));
...
public function edit41($id)
    {
            ...
            return view('pages.edit.pendidikaneditsltp',compact('tabel41'));
    }

public function update41(Request $request, $id){
        $this->validate($request,[ 
            'kecamatan'=>'required',
            'jumlah_sltp'=>'required',
            'jumlah_guru'=>'required',
            'jumlah_murid'=>'required',
            'negeri'=>'required',
            'swasta'=>'required',
        ...
        $input_data=$request->all();
        pendidikansltp::where('id',$id)->update([
            'kecamatan'=>$input_data['kecamatan'],
            'jumlah_sltp'=>$input_data['jumlah_sltp'],
            'jumlah_guru'=>$input_data['jumlah_guru'],
            'jumlah_murid'=>$input_data['jumlah_murid'],
            'negeri'=>$input_data['negeri'],
            'swasta'=>$input_data['swasta'],
            ...
            'tahun'=>$input_data['tahun'],
            'status'=>$input_data['status']]);
        return redirect('/pendidikansltp')->with('message','Update already Update!');
    }
    public function exportpdf41()
    {
        $pendidikant = pendidikansltp::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pendidikan_sltp_pdf', ['pendidikant' => $pendidikant]);
        return $pdf->download('pendidikansltp.pdf');
    }
...

    {
       ...
       //kesehatan jumlah dokter
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pages.pendidikansltp",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
...

    {
       ...
       //kesehatan jumlah dokter
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pages.pendidikanpaud",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
...

    {
       ...
       //kesehatan jumlah dokter
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pendidikan.pendidikanpaud",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
...
public function pendidikan2(Request $request)

    {
       ...
       //kesehatan jumlah dokter
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pendidikan.pendidikansd",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
...

    {
       ...
       //kesehatan jumlah dokter
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pendidikan.pendidikansltp",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
