    ...
    public function index1(Request $request)
    {
       ...
       //kesehatan jumlah dokter
        ...
        if($request->has('cari')){
            ...
            return view("pages.pariwisata",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
...
{
	DB::table('pariwisata_jumlah_wisata')->where('id',$id)->delete();
	return redirect('/pariwisata');
}

public function edit33($id)
    {
            $tabel33 = pariwisata::FindOrFail($id);
            return view('pages.edit.pariwisataedit',compact('tabel33'));
    }

public function update33(Request $request, $id){
        $this->validate($request,[ 
            'bulan'=>'required',
            'wisata_asing'=>'required',
            'wisata_nusantara'=>'required',
            'tahun'=>'required',
            'status'=>'required',
        ]);
        $input_data=$request->all();
        pariwisata::where('id',$id)->update([
            'bulan'=>$input_data['bulan'],
            'wisata_asing'=>$input_data['wisata_asing'],
            'wisata_nusantara'=>$input_data['wisata_nusantara'],
            'tahun'=>$input_data['tahun'],
            'status'=>$input_data['status']]);
        return redirect('/pariwisata')->with('message','Update already Update!');
    }

public function formulir1(){
            return view("pages.formulir-pariwisata-jumlah-wisata");
}

    public function tambah1(Request $request)
    {
        pariwisata::create(['bulan'=> $request->bulan,
        'wisata_asing' => $request->wisata_asing, 'wisata_nusantara'=>$request->wisata_nusantara,
        'tahun'=>$request->tahun]);
        return back()->withStatus(__('Data Berhasil Disimpan'));
    }

    public function exportpdf33()
    {
        $parwis = pariwisata::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pariwisata_pdf', ['parwis' => $parwis]);
    ...
    public function search(Request $request)
    {
        ...
        if($cari != ''){
            $tbl33= pariwisata::where('bulan','LIKE','%'.$cari.'%')
            ->orwhere('wisata_asing', 'LIKE', '%'.$cari.'%')
            ->paginate(5)
            ->setpath('');

            if(count ($tbl33) > 0){
                return view ('pages.pariwisata', ['tbl33' => $tbl33]);
            }else{
                return view('pages.pariwisata')-> with("No Result Found!");
            }
        }else{
            return view('pages.pariwisata')-> with('Data tidak ditemukan');
        }
    }

    public function hapus35($id)
{
	DB::table('pariwisata_hotel')->where('id',$id)->delete();
	return redirect('/pariwisatahotel');
}

public function exportpdf34()
    {
        $parwishotel = pariwisatahotel::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pariwisata_hotel_pdf', ['parwishotel' => $parwishotel]);
        return $pdf->download('pariwisatahotel.pdf');
    }

    public function formulir2(){
     
            return view("pages.formulir-pariwisata-hotel");
       
}

    public function edit34($id)
    {
            $tabel34 = pariwisatahotel::FindOrFail($id);
            return view('pages.edit.pariwisataedithotel',compact('tabel34'));
    }

public function update34(Request $request, $id){
        $this->validate($request,[ 
            'kecamatan'=>'required',
            'hotel'=>'required',
        ...
        $input_data=$request->all();
        pariwisatahotel::where('id',$id)->update([
            'kecamatan'=>$input_data['kecamatan'],
            'hotel'=>$input_data['hotel'],
            'jumlah_kamar'=>$input_data['jumlah_kamar'],
            'tahun'=>$input_data['tahun'],
            'status'=>$input_data['status']]);
        return redirect('/pariwisatahotel')->with('message','Update already Update!');
    }
    public function tambah2(Request $request)
    {

        pariwisatahotel::create(['hotel'=> $request->hotel,'kecamatan'=> $request->kecamatan,
        'jumlah_kamar' => $request->jumlah_kamar, 'tahun'=>$request->tahun]);
        return back()->withStatus(__('Data Berhasil Disimpan'));
    }

    public function hapus37($id)
{
	DB::table('pariwisata_jenis_kapal')->where('id',$id)->delete();
	return redirect('/pariwisatakapal');
}


    public function exportpdf36()
    {
        $parwiskapal = pariwisatakapal::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pariwisata_kapal_pdf', ['parwiskapal' => $parwiskapal]);
        return $pdf->download('pariwisatakapal.pdf');
    }

    public function formulir3(){
       
            return view("pages.formulir-pariwisata-jenis-kapal");
      
}

    public function tambah3(Request $request)
    {
         pariwisatakapal::create(['perahu_tanpa_motor'=> $request->perahu_tanpa_motor, 'kecamatan' => $request->kecamatan,
        'perahu_motor_tempel' => $request->perahu_motor_tempel, 'kapal_motor'=>$request->kapal_motor,'tahun'=>$request->tahun]);
        return back()->withStatus(__('Data Berhasil Disimpan'));
    }

    public function edit36($id)
    {
            $tabel35 = pariwisatakapal::FindOrFail($id);
            return view('pages.edit.pariwisataeditkapal',compact('tabel35'));
    }

public function update36(Request $request, $id){
        $this->validate($request,[ 
            'kecamatan'=>'required',
            'perahu_tanpa_motor'=>'required',
            'perahu_motor_tempel'=>'required',
            'kapal_motor'=>'required',
            'tahun'=>'required',
            'status'=>'required',
        ]);
        $input_data=$request->all();
        pariwisatakapal::where('id',$id)->update([
            'kecamatan'=>$input_data['kecamatan'],
            'perahu_tanpa_motor'=>$input_data['perahu_tanpa_motor'],
            'perahu_motor_tempel'=>$input_data['perahu_motor_tempel'],
            'kapal_motor'=>$input_data['kapal_motor'],
            'tahun'=>$input_data['tahun'],
            'status'=>$input_data['status']]);
        return redirect('/pariwisatakapal')->with('message','Update already Update!');
    }

    public function hapus34($id)
{
	DB::table('pariwisata_objek_wisata')->where('id',$id)->delete();
	return redirect('/pariwisataobjek');
}
    public function exportpdf35()
    {
        $parwisobjek = pariwisataobjek::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pariwisata_objek_pdf', ['parwisobjek' => $parwisobjek]);
        return $pdf->download('pariwisataobjek.pdf');
    }
    public function formulir4(){
            return view("pages.formulir-pariwisata-objek");
}

    public function tambah4(Request $request)
    {
         pariwisataobjek::create(['jenis_objek_wisata'=> $request->jenis_objek_wisata ,'daerah'=> $request->daerah,
        'lokasi' => $request->lokasi, 'tahun'=>$request->tahun]);
        return back()->withStatus(__('Data Berhasil Disimpan'));
    }

    public function edit35($id)
    {
            $tabel36 = pariwisataobjek::FindOrFail($id);
            return view('pages.edit.pariwisataeditobjek',compact('tabel36'));
    }

public function update35(Request $request, $id){
        $this->validate($request,[ 
            'jenis_objek_wisata'=>'required',
            'lokasi'=>'required',
            'daerah'=>'required',
            'tahun'=>'required',
            'status'=>'required',
        ...
        $input_data=$request->all();
        pariwisataobjek::where('id',$id)->update([
            'jenis_objek_wisata'=>$input_data['jenis_objek_wisata'],
            'lokasi'=>$input_data['lokasi'],
            'daerah'=>$input_data['daerah'],
            'tahun'=>$input_data['tahun'],
            'status'=>$input_data['status']]);
        return redirect('/pariwisataobjek')->with('message','Update already Update!');
    }

    public function hapus36($id)
{
	DB::table('pariwisata_kunjungan_kapal')->where('id',$id)->delete();
	return redirect('/pariwisatakunjungan');
}
    public function formulir5(){
       
            return view("pages.formulir-pariwisata-kunjungan");
      
}

    public function exportpdf37()
    {
        $parwiskunjungan = pariwisatakunjungan::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pariwisata_kunjungan_pdf', ['parwiskunjungan' => $parwiskunjungan]);
        return $pdf->download('pariwisatakunjungan.pdf');
    }
    public function tambah5(Request $request)
    {
         pariwisatakunjungan::create(['jumlah_kapal'=> $request->jumlah_kapal, 'kecamatan' => $request->kecamatan,
        'jumlah_penumpang' => $request->jumlah_penumpang, 'tahun'=>$request->tahun, 'jumlah_barang'=>$request->jumlah_barang]);
        return back()->withStatus(__('Data Berhasil Disimpan'));
    }

    public function edit37($id)
    {
            $tabel37 = pariwisatakunjungan::FindOrFail($id);
            return view('pages.edit.pariwisataeditkunjungan',compact('tabel37'));
    }

public function update37(Request $request, $id){
        $this->validate($request,[ 
            'kecamatan'=>'required',
            'jumlah_kapal'=>'required',
        ...
        $input_data=$request->all();
        pariwisatakunjungan::where('id',$id)->update([
            'kecamatan'=>$input_data['kecamatan'],
            'jumlah_kapal'=>$input_data['jumlah_kapal'],
            'jumlah_penumpang'=>$input_data['jumlah_penumpang'],
            'jumlah_barang'=>$input_data['jumlah_barang'],
            'tahun'=>$input_data['tahun'],
            'status'=>$input_data['status']]);
        return redirect('/pariwisatakunjungan')->with('message','Update already Update!');
    }

    public function hapus38($id)
{
	DB::table('pariwisata_restoran')->where('id',$id)->delete();
	return redirect('/pariwisatarestoran');
}
    public function formulir6(){
       
            return view("pages.formulir-pariwisata-restoran");
}

    public function tambah6(Request $request)
    {
         pariwisatarestoran::create(['jumlah'=> $request->jumlah, 'kecamatan' => $request->kecamatan,
        'tahun'=>$request->tahun]);
        return back()->withStatus(__('Data Berhasil Disimpan')); 
    }
public function edit38($id)
    {
            $tabel38 = pariwisatarestoran::FindOrFail($id);
            return view('pages.edit.pariwisataeditrestoran',compact('tabel38'));
    }

public function update38(Request $request, $id){
        $this->validate($request,[ 
            'kecamatan'=>'required',
            'jumlah'=>'required',
            'tahun'=>'required',
        ...
        $input_data=$request->all();
        pariwisatarestoran::where('id',$id)->update([
            'kecamatan'=>$input_data['kecamatan'],
            'jumlah'=>$input_data['jumlah'],
            'tahun'=>$input_data['tahun'],
            'status'=>$input_data['status']]);
        return redirect('/pariwisatarestoran')->with('message','Update already Update!');
    }

    public function exportpdf38()
    {
        $parwisrestoran = pariwisatarestoran::all()->where('status','=','Accepted');
        $pdf = PDF::loadView('pages.export.pariwisata_restoran_pdf', ['parwisrestoran' => $parwisrestoran]);
        return $pdf->download('pariwisatarestoran.pdf');
    }
 ...
 $categories39 = [];
       ...
       $categories40 = [];
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pages.pariwisatahotel",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
 ...
 $categories39 = [];
       ...
       $categories40 = [];
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pages.pariwisatakapal",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
 ...
 $categories39 = [];
       ...
       $categories40 = [];
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pages.pariwisataobjek",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
 ...
 $categories39 = [];
       ...
       $categories40 = [];
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pages.pariwisatakunjungan",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
 ...
 $categories39 = [];
       ...
       $categories40 = [];
        ...
        foreach ($tbl53 as $tabel52){
            ...
            return view("pages.pariwisatarestoran",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
...
public function pariwisata1(Request $request)
    {
        $i=0;
       ...
       //kesehatan jumlah dokter
        ...
        if($request->has('cari')){
            ...
            return view("pariwisata.pariwisata",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
    ...
    public function pariwisata2(Request $request)
    {
        $i=0;
       ...
       //kesehatan jumlah dokter
        ...
        if($request->has('cari')){
            ...
            return view("pariwisata.pariwisataobjek",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
    ...
    public function pariwisata3(Request $request)
    {
        $i=0;
       ...
       //kesehatan jumlah dokter
        ...
        if($request->has('cari')){
            ...
            return view("pariwisata.pariwisatahotel",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
    ...
    public function pariwisata4(Request $request)
    {
        $i=0;
       ...
       //kesehatan jumlah dokter
        ...
        if($request->has('cari')){
            ...
            return view("pariwisata.pariwisatakunjungan",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
    ...
    public function pariwisata5(Request $request)
    {
        $i=0;
       ...
       //kesehatan jumlah dokter
        ...
        if($request->has('cari')){
            ...
            return view("pariwisata.pariwisatakapal",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
    ...
    public function pariwisata6(Request $request)
    {
        $i=0;
       ...
       //kesehatan jumlah dokter
        ...
        if($request->has('cari')){
            ...
            return view("pariwisata.pariwisatarestoran",  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
