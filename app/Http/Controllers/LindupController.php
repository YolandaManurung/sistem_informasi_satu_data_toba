...
use App\Model_PDAM_jumlah_pemakaian_air_bersih;
use App\Model_Lindup_izin_lingkungan_berdasarkan_perusahaan;
use App\Model_Lindup_produksi_sampah;
use App\Model_Lindup_jenis_daur_ulang_sampah;
...
class LindupController extends Controller
{
...

    {
       ...
       //kesehatan jumlah dokter
        ...
        $tbl58=DB::table('lindup_jenis_perusahaan')->paginate(10);
        $jumlah_izin_perusahaan=0;
        foreach ($tbl58 as $tabel58){
            $jumlah_izin_perusahaan+=$tabel58->amdal+$tabel58->ukl_upl+$tabel58->sppl;
        }

        $jumlah_amdal=0;
        foreach ($tbl58 as $tabel52){
            $jumlah_amdal+=$tabel58->amdal;   
        }

        $jumlah_ukl_upl=0;
        foreach ($tbl58 as $tabel52){
            $jumlah_ukl_upl+=$tabel58->ukl_upl;
        }

        $jumlah_sppl=0;
        foreach ($tbl58 as $tabel52){
            $jumlah_sppl+=$tabel58->sppl;
        }

        $tbl58a=DB::table('lindup_jenis_perusahaan')->where('status', '=', 'Accepted')->get();
        $categories58 = [];
        $data58a = [];
        $data58b = [];
        $data58c = [];
        foreach ($tbl58a as $tabel52){
            $categories58[] = $tabel52->nama_perusahaan;
            $data58a[] = $tabel52->amdal;
            $data58b[] = $tabel52->ukl_upl;
            $data58c[] = $tabel52->sppl;
        ...
        if($request->has('cari')){
            ...
            return view('pages.lindup_izin_lingkungan_berdasarkan_perusahaan',  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
        ...
        ,'data39','data39a','data39b','data40','data40a','data40b','data36','data36a','data36b','jumlah_panjang_jalan','tbl44c','data43a','data43b','data44c','data44a',
            ...
            'tbl58a', 'tbl58', 'categories58', 'data58a', 'data58b', 'data58c', 'jumlah_izin_perusahaan', 'jumlah_amdal', 'jumlah_ukl_upl', 'jumlah_sppl'));
...

    {
       ...
       //kesehatan jumlah dokter
        ...
        $tbl59 = DB::table('lindup_produksi_sampah')->paginate(10);
        $tbl59a = DB::table('lindup_produksi_sampah')->where('status', '=', 'Accepted')->get();

            return view('pages.lindup_jumlah_produksi_sampah',  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
        ...
        ,'data39','data39a','data39b','data40','data40a','data40b','data36','data36a','data36b','jumlah_panjang_jalan','tbl44c','data43a','data43b','data44c','data44a',
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl59', 'tbl59a'));
    ...
    public function lindup1(Request $request)

    {
       ...
       //kesehatan jumlah dokter
        ...
        $tbl58=DB::table('lindup_jenis_perusahaan')->where('status', '=', 'Accepted')->paginate(10);
        $jumlah_izin_perusahaan=0;
        foreach ($tbl58 as $tabel58){
            $jumlah_izin_perusahaan+=$tabel58->amdal+$tabel58->ukl_upl+$tabel58->sppl;
        }
        ...
        if($request->has('cari')){
            ...
            return view('lindup.lindup_izin_lingkungan_berdasarkan_perusahaan',  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
    ...
    public function lindup2(Request $request)

    {
       ...
       //kesehatan jumlah dokter
        ...
        $tbl59 = DB::table('lindup_produksi_sampah')->where('status', '=', 'Accepted')->paginate(10);
        $tbl59a = DB::table('lindup_produksi_sampah')->where('status', '=', 'Accepted')->get();
        

            return view('lindup.lindup_jumlah_produksi_sampah',  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
    ...
    public function lindup3(Request $request)

    {
       ...
       //kesehatan jumlah dokter
        ...
        $tbl60=DB::table('lindup_jenis_daur_ulang_sampah')->where('status', '=', 'Accepted')->paginate(10);
        $tbl60a=DB::table('lindup_jenis_daur_ulang_sampah')->where('status','=', 'Accepted')->get();
        $categories60 = [];
        $data60a = [];
        $data60b = [];
        $data60c = [];
        ...
        foreach ($tbl60a as $tabel52){
            $categories60[] = $tabel52->kecamatan;
            $data60a[] = $tabel52->daur_ulang;
            $data60b[] = $tabel52->ton;
            $data60c[] = $tabel52->produksi;

            
        }
       
            return view('lindup.lindup_jenis_daur_ulang_sampah',  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
        ...
        ,'data39','data39a','data39b','data40','data40a','data40b','data36','data36a','data36b','jumlah_panjang_jalan','tbl44c','data43a','data43b','data44c','data44a',
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl60', 'tbl60a', 'categories60', 'data60a', 'data60b', 'data60c'));
        
    }

    public function formulir1(){
        
        return view("pages.formulir-lindup_izin_lingkungan_berdasarkan_perusahaan");
         
        }
    
        public function tambah1(Request $request)
        {
            Model_Lindup_izin_lingkungan_berdasarkan_perusahaan::create([
                'nama_perusahaan' => $request->nama_perusahaan,
                'amdal' => $request->amdal, 
                'ukl_upl' => $request->ukl_upl, 
                'sppl' => $request->sppl, 
                'jumlah' => $request->jumlah, 
                'tahun'=>$request->tahun]);
            return redirect('/lindup_izin_lingkungan_berdasarkan_perusahaan');
        }
    
        public function hapus1($id)
        {
            Model_Lindup_izin_lingkungan_berdasarkan_perusahaan::where('id',$id)->delete();
            return back();
        }
        ...
        {
                $tabel58 =Model_Lindup_izin_lingkungan_berdasarkan_perusahaan::FindOrFail($id);
                return view('pages.edit.edit-lindup_izin_lingkungan_berdasarkan_perusahaan',compact('tabel58'));
        }
        ...
        public function update1(Request $request, $id){
            ...
            Model_Lindup_izin_lingkungan_berdasarkan_perusahaan::where('id',$id)->update([
                'nama_perusahaan'=>$input_data['nama_perusahaan'],
                'amdal'=>$input_data['amdal'],
                'ukl_upl'=>$input_data['ukl_upl'],
                'sppl'=>$input_data['sppl'],
                'jumlah'=>$input_data['jumlah'],
                'tahun'=>$input_data['tahun'],
                'status'=>$input_data['status']]);
            return redirect('/lindup_izin_lingkungan_berdasarkan_perusahaan')->with('message','Data Berhasil Diupdate!!');   
        }
    
        public function exportpdf1()
        {
            $tbl58 = \App\Model_Lindup_izin_lingkungan_berdasarkan_perusahaan::all()->where('status','=','Accepted');
            $pdf = PDF::loadView('pages.export.export_lindup_izin_lingkungan_berdasarkan_perusahaan', ['tbl58' => $tbl58]);
            ...
            return $pdf->download('lindup_izin_lingkungan_berdasarkan_perusahaan.pdf');
        }

        public function formulir2(){
        
            return view("pages.formulir-lindup_jumlah_produksi_sampah");
             
            }
        
            public function tambah2(Request $request)
            {
                Model_Lindup_produksi_sampah::create([
                    'kecamatan' => $request->kecamatan,
                    'bulan' => $request->bulan, 
                    'produksi_m3' => $request->produksi_m3, 
                    'terangkat' => $request->terangkat, 
                    'tahun'=>$request->tahun]);
                return redirect('/lindup_jumlah_produksi_sampah');
            }
        
            public function hapus2($id)
            {
                Model_Lindup_produksi_sampah::where('id',$id)->delete();
                return back();
            }
            ...
            {
                    $tabel59 =Model_Lindup_produksi_sampah::FindOrFail($id);
                    return view('pages.edit.edit-lindup_jumlah_produksi_sampah',compact('tabel59'));
            }
            ...
            public function update2(Request $request, $id){
                ...
                $input_data=$request->all();
                Model_Lindup_produksi_sampah::where('id',$id)->update([
                    'kecamatan'=>$input_data['kecamatan'],
                    'bulan'=>$input_data['bulan'],
                    'produksi_m3'=>$input_data['produksi_m3'],
                    'terangkat'=>$input_data['terangkat'],
                    'tahun'=>$input_data['tahun'],
                    'status'=>$input_data['status']]);
                return redirect('/lindup_jumlah_produksi_sampah')->with('message','Data Berhasil Diupdate!!');   
            }
        
            public function exportpdf2()
            {
                $tbl59 = \App\Model_Lindup_produksi_sampah::all()->where('status','=','Accepted');
                $pdf = PDF::loadView('pages.export.export_lindup_jumlah_produksi_sampah', ['tbl59' => $tbl59]);
                PDF::setOptions(['isPhpEnabled' => true]);
                PDF::setOptions(['javascript-delay' => 1000]);
                PDF::setOptions(['no-stop-slow-scripts' => true]);
                PDF::setOptions(['enable-smart-shrinking' => true]);
                
                return $pdf->download('lindup_jumlah_produksi_sampah.pdf');
            }

            public function formulir3(){
        
                return view("pages.formulir-lindup_jenis_daur_ulang_sampah");
                 
                }
            
                public function tambah3(Request $request)
                {
                    Model_Lindup_jenis_daur_ulang_sampah::create([
                        'kecamatan' => $request->kecamatan,
                        'daur_ulang' => $request->daur_ulang, 
                        'ton' => $request->ton, 
                        'produksi' => $request->produksi, 
                        'tahun'=>$request->tahun]);
                    return redirect('/lindup_jenis_daur_ulang_sampah');
                }
            
                public function hapus3($id)
                {
                    Model_Lindup_jenis_daur_ulang_sampah::where('id',$id)->delete();
                    return back();
                }
                ...
                {
                        $tabel60 =Model_Lindup_jenis_daur_ulang_sampah::FindOrFail($id);
                        return view('pages.edit.edit-lindup_jenis_daur_ulang_sampah',compact('tabel60'));
                }
                ...
                public function update3(Request $request, $id){
                    ...
                    $input_data=$request->all();
                    Model_Lindup_jenis_daur_ulang_sampah::where('id',$id)->update([
                        'kecamatan'=>$input_data['kecamatan'],
                        'daur_ulang'=>$input_data['daur_ulang'],
                        'ton'=>$input_data['ton'],
                        'produksi'=>$input_data['produksi'],
                        'tahun'=>$input_data['tahun'],
                        'status'=>$input_data['status']]);
                    return redirect('/lindup_jenis_daur_ulang_sampah')->with('message','Data Berhasil Diupdate!!');   
                }
            
                public function exportpdf3()
                {
                    $tbl60 = \App\Model_Lindup_jenis_daur_ulang_sampah::all()->where('status','=','Accepted');
                    $pdf = PDF::loadView('pages.export.export_lindup_jenis_daur_ulang_sampah', ['tbl60' => $tbl60]);
                    PDF::setOptions(['isPhpEnabled' => true]);
                    PDF::setOptions(['javascript-delay' => 1000]);
                    PDF::setOptions(['no-stop-slow-scripts' => true]);
                    PDF::setOptions(['enable-smart-shrinking' => true]);
                    
                    return $pdf->download('lindup_jenis_daur_ulang_sampah.pdf');
                }
