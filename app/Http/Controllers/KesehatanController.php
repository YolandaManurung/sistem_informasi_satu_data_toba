...
class KesehatanController extends Controller
{
    ...
    public function index1(Request $request)
    {
       ...
       $data24h = [];
       $data24i = [];
       foreach ($tbl24a as $tabel24a){
           $categories24[] = $tabel24a->kecamatan;
           $data24[] = $tabel24a->rastra_non_PKH;
           $data24a[] = $tabel24a->RLTH;
           $data24b[] = $tabel24a->KUBE;
           $data24c[] = $tabel24a->pendamping_anak_berhadapan_dengan_hukum; 
           $data24d[] = $tabel24a->KAT; 
           $data24e[] = $tabel24a->PKH; 
           $data24f[] = $tabel24a->ASLUT; 
           $data24g[] = $tabel24a->ASPD; 
           $data24h[] = $tabel24a->ODHA; 
           $data24i[] = $tabel24a->UEP_lansia; 
       }
    ...
    public function index2(Request $request)
    {
      ...
      //kesehatan jumlah dokter
       ...
       $data25a = [];
       $data25b = [];
       foreach ($tbl25a as $tabel25a){
           $categories25[] = $tabel25a->unit_kerja;
           $data25[] = $tabel25a->dokter_umum;
           $data25a[] = $tabel25a->dokter_gigi;
           $data25b[] = $tabel25a->dokter_spesialis;
       }
       //kesehatan jumlah tenaga ksesehatan
       $tbl26=DB::table('kesehatan_jumlah_tenaga_kesehatan')->paginate(10);
       $jumlah_tenaga_medis=0;
        ...
        public function index3(Request $request)
    {
      ...
      //kesehatan jumlah dokter
       ...
       $data26c = [];
       $data26d = [];
       foreach ($tbl26a as $tabel26a){
           $categories26[] = $tabel26a->kecamatan;
           $data26[] = $tabel26a->tenaga_medis;
           $data26a[] = $tabel26a->tenaga_keperawatan;
           $data26b[] = $tabel26a->tenaga_kebidanan;
           $data26c[] = $tabel26a->tenaga_kefarmasian;
           $data26d[] = $tabel26a->tenaga_kesehatan_lainnya;
       }
        ...
        public function index4(Request $request)
    {
      ...
      //kesehatan jumlah dokter
       ...
       //kesehatan jumlah fasilitas kesehatan
       $tbl27=DB::table('kesehatan_jumlah_fasilitas_kesehatan')->paginate(10);
       $tbl27a=DB::table('kesehatan_jumlah_fasilitas_kesehatan')->where('status', '=', 'Accepted')->get();
       $jumlah_rumah_sakit=0;
       foreach ($tbl27 as $tabel27){
           $jumlah_rumah_sakit+=$tabel27->rumah_sakit;
       }
       ...
       $data27g = [];
       $data27h = [];
       foreach ($tbl27a as $tabel27a){
           $categories27[] = $tabel27a->kecamatan;
           $data27[] = $tabel27a->rumah_sakit;
           $data27a[] = $tabel27a->rumah_bersalin;
           $data27b[] = $tabel27a->puskesmas;
           $data27c[] = $tabel27a->puskesmas_pembantu; 
           $data27d[] = $tabel27a->poskesdes; 
           $data27e[] = $tabel27a->balai_kesehatan; 
           $data27f[] = $tabel27a->polindes; 
           $data27g[] = $tabel27a->apotek; 
           $data27h[] = $tabel27a->toko_obat; 
       }
       ...
       foreach ($tbl31 as $tabel31){
        ...
        if($request->has('cari')){
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl27a'));
        }
        public function index5(Request $request)
    {
      ...
      //kesehatan jumlah dokter
       ...
       //kesehatan jumlah kasus penyakit
       $tbl28=DB::table('kesehatan_jumlah_kasus_penyakit_terbanyak')->paginate(10);
       $tbl28a=DB::table('kesehatan_jumlah_kasus_penyakit_terbanyak')->where('status', '=', 'Accepted')->get();
       $categories28 = [];
       $data28 = [];
       foreach ($tbl28a as $tabel28a){
           $categories28[] = $tabel28a->jenis_penyakit;
           $data28[] = $tabel28a->jumlah_kunjungan;
       }
       ...
       foreach ($tbl31 as $tabel31){
        ...
        if($request->has('cari')){
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl28a'));
        }
        public function index6(Request $request)
    {
      ...
      //kesehatan jumlah dokter
       ...
       //kesehatan jumlah akseptor
       $tbl29=DB::table('kesehatan_jumlah_akseptor_aktif_dan_alat_kontrasepsi')->paginate(10);
       $tbl29a=DB::table('kesehatan_jumlah_akseptor_aktif_dan_alat_kontrasepsi')->where('status', '=', 'Accepted')->get();
       $jumlah_iud=0;
       foreach ($tbl29 as $tabel29){
           $jumlah_iud+=$tabel29->iud;
       }
       ...
       $data29f = [];
       $data29g = [];
       foreach ($tbl29a as $tabel29a){
           $categories29[] = $tabel29a->kecamatan;
           $data29[] = $tabel29a->iud;
           $data29a[] = $tabel29a->mow;
           $data29b[] = $tabel29a->mop;
           $data29c[] = $tabel29a->implant; 
           $data29d[] = $tabel29a->suntik; 
           $data29e[] = $tabel29a->pil; 
           $data29f[] = $tabel29a->kondom; 
           $data29g[] = $tabel29a->jumlah; 
       }
       //kesehatan jumlah bayi lahir
       $tbl30=DB::table('kesehatan_jumlah_bayi_bblr')->paginate(10);
       $jumlah_bayi_lahir=0;
       ...
       foreach ($tbl31 as $tabel31){
        ...
        if($request->has('cari')){
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl29a'));
        }
        public function index7(Request $request)
    {
      ...
      //kesehatan jumlah dokter
       ...
       //kesehatan jumlah bayi lahir
       $tbl30=DB::table('kesehatan_jumlah_bayi_bblr')->paginate(10);
       $tbl30a=DB::table('kesehatan_jumlah_bayi_bblr')->where('status', '=', 'Accepted')->get();
       $jumlah_bayi_lahir=0;
       foreach ($tbl30 as $tabel30){
           $jumlah_bayi_lahir+=$tabel30->bayi_lahir;
       }
       ...
       $data30b = [];
       $data30c = [];
       foreach ($tbl30a as $tabel30a){
           $categories30[] = $tabel30a->kecamatan;
           $data30[] = $tabel30a->bayi_lahir;
           $data30a[] = $tabel30a->BBLR_jumlah;
           $data30b[] = $tabel30a->BBLR_dirujuk;
           $data30c[] = $tabel30a->BBLR_giji_buruk;  
       }
       //kesehatan daftar panti asuhan
       $tbl31=DB::table('kesehatan_daftar_panti_asuhan')->paginate(10);
       $categories31 = [];
       ...
       foreach ($tbl31 as $tabel31){
        ...
        if($request->has('cari')){
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl30a'));
        }
        public function index8(Request $request)
    {
      ...
      //kesehatan jumlah dokter
       ...
       //kesehatan daftar panti asuhan
       $tbl31=DB::table('kesehatan_daftar_panti_asuhan')->paginate(10);
       $tbl31a=DB::table('kesehatan_daftar_panti_asuhan')->where('status', '=', 'Accepted')->get();
       $categories31 = [];
       $data31 = [];
       foreach ($tbl31a as $tabel31a){
           $categories31[] = $tabel31a->nama_panti;
           $data31[] = $tabel31a->jumlah_penghuni; 
       }        
        ...
        if($request->has('cari')){
            ...
            'jumlah_penduduk','tbl43', 'i', 'tbl44', 'tbl45', 'tbl46', 
            'tbl47', 'tbl48', 'tbl49', 'tbl50', 'tbl51', 'tbl52', 'jumlah_alokasi_formula', 
            'jumlah_pengguna_dana_desa', 'tabel2', 'tbl31a'));
        }
