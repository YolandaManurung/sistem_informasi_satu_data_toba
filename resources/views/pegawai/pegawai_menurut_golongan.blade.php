...
@section('content')
    <div class="content">
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/pegawai_menurut_golongan/exportpdf54" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                <td></td>
                                    ...
                                    <td align="center"><b><b>{{number_format($jumlah_pendidikan_total, 0, ".", ".")}}</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    </tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/pegawai_menurut_jenis_kelamin1')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/pegawai_menurut_pendidikan1')}}">Next</a>
            </li>
        </ul>
        </nav>
