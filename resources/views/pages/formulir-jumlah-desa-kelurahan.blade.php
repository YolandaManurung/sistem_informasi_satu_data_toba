            ...
            <div class="section-image">
                ...
                <div class="row">
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ url('/formulir/tambah-jlh-desa-kelurahan')}}" autocomplete="off">
                            {{ @csrf_field() }}
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="desa" name="desa" id="input-desa" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Masukkan Jumlah Desa') }}" value="{{ old('desa') }}" required>
        
                                        @include('alerts.feedback', ['field' => 'desa'])
                                    </div>
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-kelurahan">{{ __('Jumlah Kelurahan') }}</label>
                                        <input type="kelurahan" name="kelurahan" id="input-kelurahan" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Masukkan Jumlah Kelurahan') }}" value="{{ old('kelurahan') }}" required>
