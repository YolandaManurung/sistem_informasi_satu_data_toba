...
@section('content')
    <div class="content">
        <div class="container-fluid">
           ...
           <div class="col-12 text-right">
                                <a href="{{url('/tambah_luas_tanaman_dan_produksi_karet_dan_kelapa_sawit')}}" class="btn btn-sm btn-default">Tambahkan Data</a>
                            </div>
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item">
      <a class="page-link" href="{{url('/luas_tanaman_dan_produksi_aren_dan_kemiri')}}">Next</a>
    </li>
  </ul>
</nav>
