            ...
            <div class="row">
                ...
                <div class="col-md-12"> 
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_daftar_industri_kecil_dan_menengah')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
...
<!-- </div> --> 
                        ...
                        <div class="card-body table-full-widtd align="center" table-responsive" >
                            ...
                            &nbsp
                                   <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/daftar_industri_kecil_dan_menengah/hapus13/{{ $tabel13->id }}">Hapus</a>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item disabled">
      <a class="page-link" href="{{url('/daftar_industri_kecil_dan_menengah')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    
    <li class="page-item"><a class="page-link" href="{{url('/daftar_industri_kecil_dan_menengah')}}">1</a></li>
    <li class="page-item"><a class="page-link" href="{{url('/jumlah_industri_dan_tenaga_kerja')}}">2</a></li>
   

    <li class="page-item">
      <a class="page-link" href="{{url('/jumlah_industri_dan_tenaga_kerja')}}">Next</a>
    </li>
  </ul>
</nav>
