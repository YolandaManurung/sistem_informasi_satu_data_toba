    ...
    <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('formulir-rawat-inap-kelas')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/rawat_inap_kelas1/exportpdf61" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                             <thead class="table">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                <a href="{{ url('/edit61/'.$tabel61->id) }}" class="btn btn-sm btn-success">Edit</a>
                            &nbsp
                            <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/rawat_inap_kelas/hapus61/{{ $tabel61->id }}" >Hapus</a>
                    </td>
                    </tr>
                                    @endforeach
        ...
        <ul class="pagination justify-content-center">
          ...
          <li class="page-item"><a class="page-link" href="{{url('/rawat_inap_kelas')}}">1</a></li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/tenaga_dokter')}}">Next</a>
            </li>
        </ul>
        </nav>
