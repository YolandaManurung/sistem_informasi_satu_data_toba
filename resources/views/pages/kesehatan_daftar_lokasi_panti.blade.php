...
@section('content')
    <div class="content">
            ...
            <div class="row">
                ...
                <div id="chart1"></div> 
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_daftar_panti_asuhan')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                        </div>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="/kesehatan_jumlah_bayi_lahir" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
