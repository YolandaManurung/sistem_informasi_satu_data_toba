...
@section('content')
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            @foreach($tbl51 as $tabel51)
                                <?php $i++; ?>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit51/'.$tabel51->id) }}" class="btn btn-sm btn-success">Edit</a>
                                        &nbsp
                                    <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/pembagian-penetapan-besaran-alokasi-dana-desa/hapus/{{ $tabel51->id }}">Hapus</a>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item"><a class="page-link" href="{{url('/infrastruktur_pembagian_penetapan_besaran_alokasi_dana_desa')}}">1</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/infrastruktur_perhitungan_dana_desa')}}">2</a></li>
                       
            <li class="page-item">
            <a class="page-link" href="/infrastruktur_perhitungan_dana_desa">Next</a>
            </li>
        </ul>
    </nav>
@endsection
