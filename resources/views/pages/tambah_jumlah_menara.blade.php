            ...
            <div class="section-image">
                ...
                <div class="row">
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ url('/formulir/tambah_jumlah_menara')}}" autocomplete="off">
                            {{ @csrf_field() }}
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="jumlah_menara" id="input-name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Jumlah Menara') }}" value="" required>
