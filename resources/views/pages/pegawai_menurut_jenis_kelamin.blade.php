...
@section('content')
    <div class="content">
            ...
            <div class="row">
                ...
                <div id="chart2">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_pegawai_menurut_jenis_kelamin')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/pegawai_menurut_jenis_kelamin/exportpdf53" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="{{ url('/edit53/'.$tabel53->id) }}" class="btn btn-sm btn-success">Edit</a>
                            &nbsp
                                   
                            <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/pegawai_menurut_jenis_kelamin/hapus53/{{ $tabel53->id }}" >Hapus</a>
                    </td>
                    </tr>
                                @endforeach
                                <tr>
        ...
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/pegawai_menurut_golongan')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
