...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-12">  
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_jumlah_ternak_dipotong')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/peternakan_populasi_ternak_unggas_dan_jenis_ternak')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="{{url('/peternakan_jumlah_ternak_unggas_dipotong')}}">Next</a>
    </li>
  </ul>
</nav>
