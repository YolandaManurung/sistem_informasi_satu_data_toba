...
@section('content')
    <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="/tambah-panjang-jalan" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                ...
                <a href="/infrastruktur_panjang_jalan/exportpdf4" class="btn btn-sm btn-warning">CETAK PDF</a>          
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit46/'.$tabel46->id) }}" class="btn btn-sm btn-success">Edit</a>
                                        &nbsp
        ...
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/infrastruktur_jembatan')}}">Next</a>
            </li>
        </ul>
        </nav>
