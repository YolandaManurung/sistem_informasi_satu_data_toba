...
@section('content')
    <div class="content">
             ...
             <div class="row"><div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('formulir-peralatan-rumah-sakit')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                    </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/peralatan_rumah_sakit1/exportpdf63" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                             <thead class="table">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                <a href="{{ url('/edit63/'.$tabel63->id) }}" class="btn btn-sm btn-success">Edit</a>
                            &nbsp
                            <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/peralatan_rumah_sakit/hapus63/{{ $tabel63->id }}" >Hapus</a>
                    </td>
                    </tr>
                                    @endforeach
        ...
        <ul class="pagination justify-content-center">
            ...
            <a class="page-link" href="{{url('/tenaga_dokter')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
          ...
          <li class="page-item"><a class="page-link" href="{{url('/rawat_inap_kelas')}}">1</a></li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/perawat_penyakit')}}">Next</a>
            </li>
        </ul>
        </nav>
        </div>
