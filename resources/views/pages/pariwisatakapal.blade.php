...
@section('content')
    <div class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card strpied-tabled-with-hover">
                      ...
                      <div class="col-12 text-right">
                                <a href="{{url('formulir-pariwisata-jenis-kapal')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
        ...
        <ul class="pagination justify-content-center">
            ...
            <a class="page-link" href="{{url('/pariwisatahotel')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
           ...
           <li class="page-item"><a class="page-link" href="{{url('/pariwisata')}}">1</a></li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/pariwisataobjek')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
