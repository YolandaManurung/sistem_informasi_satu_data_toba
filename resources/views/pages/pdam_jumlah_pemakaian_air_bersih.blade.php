            ...
            <div class="row">               
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah-pdam_jumlah_pemakaian_air_bersih')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                    </div>
                        ...
                        <div class="card-body table-full-width table-responsive" >
                            <table class="table table-hover table-striped" id="datatables">
                                ...
                                @foreach($tbl57 as $tabel57)
                                    ...
                                    <td align="center">{{$tabel57->status}}</td>
                                    <td align="center">
                                    <a href="{{ url('/edit57/'.$tabel57->id) }}" class="btn btn-sm btn-success">Edit</a>
                                        &nbsp
                                    <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/pdam_jumlah_pemakaian_air_bersih/hapus/{{ $tabel57->id }}">Hapus</a> 
