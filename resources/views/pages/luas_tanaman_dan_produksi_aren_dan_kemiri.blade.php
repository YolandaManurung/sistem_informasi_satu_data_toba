...
<!--                             
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_luas_tanaman_dan_produksi_aren_dan_kemiri')}}" class="btn btn-sm btn-default">Tambahkan Data</a>
                            </div>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/luas_tanaman_dan_produksi_karet_dan_kelapa_sawit')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="{{url('/luas_tanaman_dan_produksi_kelapa_dan_pinang')}}">Next</a>
    </li>
  </ul>
</nav>
