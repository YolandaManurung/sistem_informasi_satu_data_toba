@extends('layouts.app', ['activePage' => 'tambah_jumlah_ternak_dipotong', 'title' => 'Sistem Informasi Pusat Statistik', 'navName' => 'Table List', 'activeButton' => 'laravel'])
            ...
            <div class="section-image">
                ...
                <div class="row">
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ url('/formulir/tambah_jumlah_ternak_dipotong')}}" autocomplete="off">
                            {{ @csrf_field() }}
