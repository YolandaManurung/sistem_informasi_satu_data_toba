...
@section('content')
            ...
            <div class="col-md-12">
                    ...
                    <div class="card strpied-tabled-with-hover">
                        ...
                        <div class="col-12 text-right">
                                <a href="{{url('tambah-jembatan')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                ...
                                <?php $i++; ?>
                                    ...
                                    <td>
                                    <a href="{{ url('/edit48/'.$tabel48->id) }}" class="btn btn-sm btn-success">Edit</a>
                                        &nbsp
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="infrastruktur_panjang_jalan" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/infrastruktur_panjang_jalan_kabupaten')}}">Next</a>
            </li>
        </ul>
        </nav>
@endsection
