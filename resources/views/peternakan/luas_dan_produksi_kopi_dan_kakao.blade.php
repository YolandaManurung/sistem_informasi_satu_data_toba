...
<!-- </div> -->
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item disabled">
      <a class="page-link" href="{{url('/luas_dan_produksi_kopi_dan_kakao1')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="luas_tanaman_dan_produksi_karet_dan_kelapa_sawit1">Next</a>
    </li>
  </ul>
</nav>
