...
<!--                             
                    ...
                    <!-- <div class="col-12 text-right">
                                <a href="{{url('/tambah_luas_tanaman_dan_produksi_aren_dan_kemiri')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div> -->
...
<!-- </div> -->
                            ...
                            <a href="/luas_tanaman_dan_produksi_aren_dan_kemiri/exportpdf10" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                @foreach($tbl10 as $tabel10)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ url('/edit10/'.$tabel10->id) }}" class="btn btn-sm btn-success">Edit</a>
                            &nbsp
                                   
                            <a href="/luas_tanaman_dan_produksi_aren_dan_kemiri/hapus10/{{ $tabel10->id }}" class="btn btn-sm btn-danger">Hapus</a>
                    </td> -->
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/luas_tanaman_dan_produksi_karet_dan_kelapa_sawit1')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="{{url('/luas_tanaman_dan_produksi_kelapa_dan_pinang1')}}">Next</a>
    </li>
  </ul>
</nav>
