...
@section('content')
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/peternakan_jumlah_ternak_dipotong1')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="{{url('/peternakan_jumlah_produksi_ternak_unggas1')}}">Next</a>
    </li>
  </ul>
</nav>
