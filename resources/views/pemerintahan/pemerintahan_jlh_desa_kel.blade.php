...
@section('content')
    <div class="content">
        ...
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item"><a class="page-link" href="{{url('/pemerintahan_jlh_desa_kel1')}}">1</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/pemerintahan_jlh_penduduk_wilayah_kepadatan1')}}">2</a></li>
            
            <li class="page-item">
            <a class="page-link" href="{{url('/pemerintahan_jlh_penduduk_wilayah_kepadatan1')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
