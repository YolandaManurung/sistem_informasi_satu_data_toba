          ...
          <div class="row">
                ...
                <div id="chart">
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/bantuan_pemerintah_kecamatan/exportpdf65" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                             <thead class="table">
                                ...
                                <tbody>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status65/'.$tabel65->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                    </tr>
                                    @endforeach
