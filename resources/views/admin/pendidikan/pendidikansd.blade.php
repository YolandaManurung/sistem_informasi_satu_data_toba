...
@section('content')
    <div class="content">
                         ...
                         <div class="col-12 text-left">
                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status40/'.$tabel40->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                    </tr>
                                    @endforeach
                                    <tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/pendidikanpaud')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            
            <li class="page-item"><a class="page-link" href="{{url('/admin/pendidikanpaud')}}">1</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/admin/pendidikansd')}}">2</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/admin/pendidikansltp')}}">3</a></li>
            
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/pendidikansltp')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
