...
@section('content')
    <div class="content">
                            ...
                            <a href="/pariwisatarestoran/exportpdf38" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                <tbody>
                                    ...
                                    <td align="center">{{$tabel38 -> status}}</td>
                                     <td align="center">
                                    <a href="{{ url('/edit_status38/'.$tabel38->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                    </tr>
                                    @endforeach
                                    <tr>
        ...
        <ul class="pagination justify-content-center">
            ...
            <a class="page-link" href="{{url('/admin/pariwisatakunjungan')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
