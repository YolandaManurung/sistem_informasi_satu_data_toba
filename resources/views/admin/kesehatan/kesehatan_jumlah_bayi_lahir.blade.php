@extends('layouts.app', ['activePage' => 'kesehatan_jumlah_bayi_lahir', 'title' => 'Sistem Informasi Pusat Statistik', 'navName' => 'Table List', 'activeButton' => 'laravel'])
...
@section('content')
    <div class="content">
                        ...
                        <a href="/kesehatan_jumlah_bayi/exportpdf30" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                            <table class="table table-hover table-striped">
                                ...
                                <?php $i++; ?>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status30/'.$tabel30->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                                    </tr>
                                @endforeach
                                <tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href= "{{url('/admin/kesehatan_jumlah_akseptor_aktif')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/kesehatan_daftar_lokasi_panti')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
