...
@section('content')
    <div class="content">
                        ...
                        <a href="/kesehatan_daftar_panti_asuhan/exportpdf31" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                            ...
                            <th scope="col">No</th>
                                ...
                                <?php $i++; ?>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status31/'.$tabel31->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href= "{{url('/admin/kesehatan_jumlah_bayi_lahir')}}"tabindex="-1" aria-disabled="true">Previous</a>
            </li>
