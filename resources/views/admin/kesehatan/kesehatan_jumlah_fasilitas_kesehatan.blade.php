@extends('layouts.app', ['activePage' => 'kesehatan_jumlah_fasilitas_kesehatan', 'title' => 'Sistem Informasi Pusat Statistik', 'navName' => 'Table List', 'activeButton' => 'laravel'])
...
@section('content')
    <div class="content">
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <td align="center"><b>No</td>
                                ...
                                <?php $i++; ?>
                                    ...
                                    <td align="center">{{($tabel27->tahun)}}</td>
                                    <td align="center">{{($tabel27->status)}}</td>
                                    <td align="center">
                                    <a href="{{ url('/edit_status27/'.$tabel27->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                                    </tr>
                                @endforeach
                                <tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href= "{{url('/admin/kesehatan_jumlah_tenaga_kesehatan')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/kesehatan_jumlah_kasus_penyakit')}}">Next</a>
            </li>
        </ul>
        </nav>
