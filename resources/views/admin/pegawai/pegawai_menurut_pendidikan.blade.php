...
@section('content')
    <div class="content">
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status55/'.$tabel55->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                    </tr>
                                @endforeach
                                <tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/pegawai_menurut_pendidikan')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/pegawai_yang_pindah_pensiun')}}">Next</a>
            </li>
        </ul>
        </nav>
     </div>
