...
@section('content')
    <div class="content">
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/pegawai_menurut_golongan/exportpdf54" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status54/'.$tabel54->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                    </tr>
                                @endforeach
                                <tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/pegawai_menurut_jenis_kelamin')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/pegawai_menurut_pendidikan')}}">Next</a>
            </li>
        </ul>
        </nav>
