...
@section('content')
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                ...
                                @foreach($tbl47 as $tabel47)
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status47/'.$tabel47->id) }}" class="btn btn-sm btn-primary">View Detail</a></td>
                                    </td>
                                    </tr>
                                    @endforeach
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="/admin/infrastruktur_jembatan" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
