...
@section('content')
    <div class="content">
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                ...
                                <?php $i++; ?>
                                    ...
                                    <td>
                                    <a href="{{ url('/edit_status48/'.$tabel48->id) }}" class="btn btn-sm btn-primary">View Detail</a></td>
                                    </td>
                                    </tr>
                                @endforeach
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="/admin/infrastruktur_panjang_jalan" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/infrastruktur_panjang_jalan_kabupaten')}}">Next</a>
            </li>
        </ul>
        </nav>
        </div>
