...
@section('content')
    <div class="content">
                        ...
                        <a href="/kependudukan_jumlah_akta/exportpdf22" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                            <table class="table table-hover table-striped">
                                ...
                                <?php $i++; ?>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status22/'.$tabel22->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                                    </tr>
                                @endforeach
                                <tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/kependudukan_jumlah_penduduk')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            
            <li class="page-item"><a class="page-link" href="{{url('/admin/kependudukan_jumlah_penduduk')}}">1</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/admin/kependudukan_jumlah_akta')}}">2</a></li>
