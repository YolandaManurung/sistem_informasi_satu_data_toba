...
<!-- </div> -->
                            ...
                            <a href="/luas_tanaman_dan_produksi_kelapa_dan_pinang/exportpdf11" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                @foreach($tbl11 as $tabel11)
                                    <tr>
                                        ...
                                        <td>
                                        <td align="center"> <a href="{{ url('/edit_status11/'.$tabel11->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                    </td>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/admin/luas_tanaman_dan_produksi_aren_dan_kemiri')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
