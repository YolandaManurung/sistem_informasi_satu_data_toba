...
@section('content')
    <div class="content">
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/infrastruktur_pembagian_penetapan_bagi_hasil_pajak1')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            <li class="page-item"><a class="page-link" href="{{url('/infrastruktur_pembangunan_bersumber_dana_desa1')}}">1</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/infrastruktur_pembagian_penetapan_bagi_hasil_pajak1')}}">2</a></li>
