...
<!-- 
                    ...
                    <!-- <div class="col-12 text-right">
                                <a href="{{url('/tambah_luas_dan_produksi_kopi_dan_kakao')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div> -->
...
<!-- </div> -->
                            ...
                            <a href="/luas_dan_produksi_kopi_dan_kakao/exportpdf8" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                @foreach($tbl8 as $tabel8)
                                    <tr>
                                        ...
                                        <td>
                                        <td align="center"> <a href="{{ url('/edit_status8/'.$tabel8->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                    </td>
                                    </tr>
                                    @endforeach
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item">
      <a class="page-link" href="{{url('/admin/luas_tanaman_dan_produksi_karet_dan_kelapa_sawit')}}">Next</a>
    </li>
  </ul>
</nav>
