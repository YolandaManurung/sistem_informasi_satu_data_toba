...
<!-- </div> -->
                        ...
                        <div class="card-body table-full-widtd align="center" table-responsive" >
                            ...
                            <a href="/luas_tanaman_dan_produksi_andaliman_dan_nilam/exportpdf12" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <!-- <td align="center" rowspan="2"><b>Aksi</td>                                    </tr> -->
                                ...
                                @foreach($tbl12 as $tabel12)
                                    <tr>
                                        ...
                                        <td>
                                        <td align="center"> <a href="{{ url('/edit_status12/'.$tabel12->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                    </td>
                                    </tr>
                                    @endforeach
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/admin/luas_tanaman_dan_produksi_kelapa_dan_pinang')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item disabled">
      <a class="page-link" href="{{url('/admin/luas_tanaman_dan_produksi_andaliman_dan_nilam')}}">Next</a>
    </li>
  </ul>
</nav>
