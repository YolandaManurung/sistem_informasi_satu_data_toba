...
@section('content')
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                @foreach($tbl18 as $tabel18)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ url('/edit_status18/'.$tabel18->id) }}" class="btn btn-sm btn-primary">View Detail</a>  
                    </td> 
                                    </tr>
                                    @endforeach
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <a class="page-link" href="{{url('/admin/daftar_internet_dan_game_monitoring1')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item disabled">
      <a class="page-link" href="{{url('/admin/rekapitulasi_data_menara')}}">Next</a>
    </li>
  </ul>
</nav>
