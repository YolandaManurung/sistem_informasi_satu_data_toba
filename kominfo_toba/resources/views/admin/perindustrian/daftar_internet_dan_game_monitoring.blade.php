...
<!-- TAMBAHKAN DATA -->
                    <!-- <div class="col-12 text-right">
                                <a href="{{url('/tambah_daftar_internet_dan_game_monitoring')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div> -->
                            ...
                            <a href="/daftar_internet_dan_game_monitoring/exportpdf17" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                @foreach($tbl17 as $tabel17)
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                        <a href="{{ url('/edit_status17/'.$tabel17->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                    </td>
                    <td></td>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/admin/rekapitulasi_data_menara')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    
    <li class="page-item"><a class="page-link" href="{{url('/admin/jumlah_menara')}}">1</a></li>
    <li class="page-item"><a class="page-link" href="{{url('/admin/rekapitulasi_data_menara')}}">2</a></li>
    <li class="page-item"><a class="page-link" href="{{url('/admin/daftar_internet_dan_game_monitoring')}}">3</a></li>
    <li class="page-item"><a class="page-link" href="{{url('/admin/jumlah_desa_blank_spot')}}">4</a></li>


    <li class="page-item">
      <a class="page-link" href="{{url('/admin/jumlah_desa_blank_spot')}}">Next</a>
    </li>
  </ul>
</nav>
