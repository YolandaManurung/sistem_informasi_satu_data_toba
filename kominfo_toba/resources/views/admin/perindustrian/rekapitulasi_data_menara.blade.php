...
<!-- 
 ...
 -->
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/rekapitulasi_data_menara/exportpdf16" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                @foreach($tbl16 as $tabel16)
                                    ...
                                    <td>
                                    <a href="{{ url('/edit_status16/'.$tabel16->id) }}" class="btn btn-sm btn-primary">View Detail</a>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/admin/jumlah_menara')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="{{url('/admin/daftar_internet_dan_game_monitoring')}}">Next</a>
    </li>
  </ul>
</nav>
