...
@section('content')
    <div class="content">
                        ...
                        <div class="card-body table-full-width table-responsive" >
                            <table class="table table-hover table-striped" id="datatables">
                                ...
                                @foreach($tbl43 as $tabel43)
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status43/'.$tabel43->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
        ...
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/pemerintahan_jlh_penduduk_wilayah_kepadatan')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
