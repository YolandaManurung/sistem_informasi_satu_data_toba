...
@section('content')
    <div class="content">
                     ...
                     <div class="col-12 text-left">
                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status41/'.$tabel41->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                    </tr>
                                    @endforeach
                                    <tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/pendidikansd')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
