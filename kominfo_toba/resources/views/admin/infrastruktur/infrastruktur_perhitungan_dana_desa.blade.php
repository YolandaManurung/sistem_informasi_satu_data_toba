...
@section('content')
    <div class="content">
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                ...
                                <?php $i++; 
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status52/'.$tabel52->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                                    </tr>
                                    @endforeach
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/infrastruktur_pembagian_penetapan_besaran_alokasi_dana_desa')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
