...
@section('content')
    <div class="content">
                ...
                <a href="/infrastruktur_panjang_jalan/exportpdf4" class="btn btn-sm btn-warning">CETAK PDF</a>          
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                    ...
                                    <td align="center">{{ number_format($tabel46->panjang_jalan_keadaan,2,",",".")}} km</td>
                                  
                                    <td align="center">{{$tabel46->tahun}}</td>
                                    <td align="center">{{$tabel46->status}}</td>
                                    <td align="center">
                                    <a href="{{ url('/edit_status46/'.$tabel46->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
                                    </tr>
                                    @endforeach
                                    ...
                                    <td align="center">{{ number_format($tabel46->panjang_jalan_kondisi_jalan,2,",",".")}} km</td>
        ...
        <ul class="pagination justify-content-center" align="center">
            ...
            <a class="page-link" href="{{url('/admin/infrastruktur_aplikasi_opd_toba')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            <li class="page-item"><a class="page-link" href="{{url('/admin/infrastruktur_aplikasi_opd_toba')}}">1</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/admin/infrastruktur_panjang_jalan')}}">2</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/admin/infrastruktur_jembatan')}}">3</a></li>
            <li class="page-item"><a class="page-link" href="{{url('/admin/infrastruktur_panjang_jalan_kabupaten')}}">4</a></li>
            
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/infrastruktur_jembatan')}}">Next</a>
            </li>
        </ul>
        </nav>
        </div>
