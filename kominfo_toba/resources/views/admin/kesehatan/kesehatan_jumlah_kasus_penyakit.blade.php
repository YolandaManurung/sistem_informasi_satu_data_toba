...
@section('content')
    <div class="content">
                        ...
                        <a href="/kesehatan_jumlah_kasus_penyakit/exportpdf28" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                            <table class="table table-hover table-striped">
                                ...
                                <?php $i++; ?>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit_status28/'.$tabel28->id) }}" class="btn btn-sm btn-primary">View Detail</a>
                                    </td>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/kesehatan_jumlah_fasilitas_kesehatan')}}"tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/admin/kesehatan_jumlah_akseptor_aktif')}}">Next</a>
            </li>
        </ul>
        </nav>
