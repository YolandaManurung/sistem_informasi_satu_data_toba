...
<!-- TAMBAHKAN DATA -->
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/rekapitulasi_data_menara1')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="{{url('/jumlah_desa_blank_spot1')}}">Next</a>
    </li>
  </ul>
</nav>
