...
@section('content')
    <div class="content">
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="/kesehatan_jumlah_tenaga_kesehatan1" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/kesehatan_jumlah_kasus_penyakit1')}}">Next</a>
            </li>
        </ul>
        </nav>
        </div>
