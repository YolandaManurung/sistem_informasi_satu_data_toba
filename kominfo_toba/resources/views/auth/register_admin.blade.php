...
@extends('layouts.apps', ['activePage' => 'register_admin', 'title' => 'Sistem Informasi Pusat Statistik', 'navName' => 'Table List', 'activeButton' => 'laravel'])
...
@section('content')
 ...
 <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" align="center">{{ __('Buat Akun Baru') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ url('/register_admins') }}">
