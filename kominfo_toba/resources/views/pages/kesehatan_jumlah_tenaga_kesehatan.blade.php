...
@section('content')
    <div class="content">
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="/kesehatan_jumlah_dokter" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/kesehatan_jumlah_fasilitas_kesehatan')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
