...
@section('content')
    <div class="content">
            ...
            <div class="row">
                ...
                <div id="chart2">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_jumlah_dokter')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="/kesehatan_rekapitulasi_penyandang_masalah" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/kesehatan_jumlah_tenaga_kesehatan')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
