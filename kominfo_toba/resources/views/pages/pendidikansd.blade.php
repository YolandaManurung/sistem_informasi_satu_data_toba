...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                   ...
                   <div class="col-12 text-right">
                                <a href="{{url('formulir-pendidikan-sd')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
</div>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/pendidikanpaud')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/pendidikansltp')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
