...
@section('content')
    <div class="content">
            ...
            <div class="row">               
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah-lindup_izin_lingkungan_berdasarkan_perusahaan')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive" >
                            <table class="table table-hover table-striped" id="datatables">
                                ...
                                @foreach($tbl58 as $tabel58)
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit58/'.$tabel58->id) }}" class="btn btn-sm btn-success">Edit</a>
                                        &nbsp
                                    <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/lindup_izin_lingkungan_berdasarkan_perusahaan/hapus/{{ $tabel58->id }}">Hapus</a>
                                    </td>
                                    </tr>
                                @endforeach
        ...
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/lindup_jumlah_produksi_sampah')}}">Next</a>
            </li>
        </ul>
        </nav>
    </div>
