...
@section('content')
    <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_pegawai_menurut_pendidikan')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td align="center">{{$tabel55->tahun}}</td>
                                    <td align="center">{{$tabel55->status}}</td>
                                    <td>
                                    <a href="{{ url('/edit55/'.$tabel55->id) }}" class="btn btn-sm btn-success">Edit</a>
                            &nbsp
                                   
                            <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/pegawai_menurut_pendidikan/hapus55/{{ $tabel55->id }}" >Hapus</a>
                    </td>
                    </tr>
                                @endforeach
                                <tr>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="{{url('/pegawai_menurut_pendidikan')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/pegawai_yang_pindah_pensiun')}}">Next</a>
            </li>
        </ul>
        </nav>
@endsection
