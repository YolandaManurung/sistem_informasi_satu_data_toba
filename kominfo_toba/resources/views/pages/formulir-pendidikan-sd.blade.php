@extends('layouts.app', ['activePage' => 'formulir-pendidikan-sd', 'title' => 'Sistem Informasi Pusat Statistik', 'navName' => 'Table List', 'activeButton' => 'laravel'])
            ...
            <div class="section-image">
                ...
                <div class="row">
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ url('/formulir/formulir-pendidikan-sd')}}" autocomplete="off">
                            {{ @csrf_field() }}
                                ...
                                <h6 class="heading-small text-muted mb-4">{{ __('Jumlah SD, Murid, Guru, serta Lembaga Kabupaten Toba') }}</h6>
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-desa">{{ __('Jumlah SD') }}</label>
                                        <input type="desa" name="jumlah_sd" id="input-desa" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Jumlah SD') }}" value="" required>
