            ...
            <div class="section-image">
                ...
                <div class="row">
                    ...
                    <div class="card col-md-8">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ url('/formulir/tambah_luas_tanaman_dan_produksi_kelapa_dan_pinang')}}" autocomplete="off">
                            {{ @csrf_field() }}
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="luas_areal_kelapa" id="input-luas_areal_kelapa" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Luas Areal Kelapa') }}" value="" required>
        
                                        @include('alerts.feedback', ['field' => 'name'])
                                    </div>
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-produksi_kelapa">{{ __('Produksi Kelapa (Ton)') }}</label>
                                        <input type="text" name="produksi_kelapa" id="input-produksi_kelapa" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Produksi Kelapa (Ton)') }}" value="" required>
                                    ...
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="produktivitas_kelapa" id="input-produktivitas_kelapa" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Produktivitas Kelapa (Kg/Ha)') }}" value="" required>
                                    ...
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="luas_areal_pinang" id="input-luas_areal_pinang" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Luas Areal Pinang') }}" value="" required>
        
                                        @include('alerts.feedback', ['field' => 'name'])
                                    </div>
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-produksi_pinang">{{ __('Produksi Pinang (Ton)') }}</label>
                                        <input type="text" name="produksi_pinang" id="input-produksi_pinang" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Produksi Kelapa Pinang (Ton)') }}" value="" required>
                                    ...
                                    <div class="form-group{{ $errors->has('') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="produktivitas_pinang" id="input-produktivitas_pinang" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Produktivitas Pinang (Kg/Ha)') }}" value="" required>
