...
@section('content')
    <div class="content">
                    ...
                    <div class="card strpied-tabled-with-hover">
                        ...
                        <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
                            ...
                            <div class="col-12 text-right">
                                <a href="{{url('formulir-pariwisata-kunjungan')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
        ...
        <ul class="pagination justify-content-center">
            ...
            <a class="page-link" href="{{url('/pariwisataobjek')}}" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
           ...
           <li class="page-item"><a class="page-link" href="{{url('/pariwisata')}}">1</a></li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/pariwisatarestoran')}}">Next</a>
            </li>
        </ul>
        </nav>
