...
@section('content')
    <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('tambah-pembagianpenetapanbagihasilpajak')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                ...
                                @foreach($tbl50 as $tabel50)
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit50/'.$tabel50->id) }}" class="btn btn-sm btn-success">Edit</a>
                                        &nbsp
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="infrastruktur_pembangunan_bersumber_dana_desa" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
