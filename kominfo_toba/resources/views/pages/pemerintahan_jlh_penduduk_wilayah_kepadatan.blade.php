...
@section('content')
                            ...
                            <thead>
                                ...
                                <?php $i++; 
                                 ?>
                                    ...
                                    <td>
                                    <a href="{{ url('/edit44/'.$tabel44->id) }}" class="btn btn-sm btn-success">Edit</a>
                                     &nbsp
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="{{url('/pemerintahan_jlh_desa_kel')}}" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
