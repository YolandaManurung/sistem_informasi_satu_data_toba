...
@section('content')
    <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_jumlah_akseptor')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="/kesehatan_jumlah_kasus_penyakit" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
            ...
            <li class="page-item">
            <a class="page-link" href="{{url('/kesehatan_jumlah_bayi_lahir')}}">Next</a>
            </li>
        </ul>
        </nav>
