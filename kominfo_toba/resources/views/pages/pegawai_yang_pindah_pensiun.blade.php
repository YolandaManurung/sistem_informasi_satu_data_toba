            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah_pegawai_yang_pindah_pensiun')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/pegawai_yang_pindah_pensiun/exportpdf56" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                <tr>
                                    ...
                                    <td align="center">{{$tabel56->status}}</td>
                                    <td>
                                    <a href="{{ url('/edit56/'.$tabel56->id) }}" class="btn btn-sm btn-success">Edit</a>
                            &nbsp
                                   
                            <a onclick="return confirm('Ingin Menghapus Data?')" class="btn btn-sm btn-danger" href="/pegawai_yang_pindah_pensiun/hapus56/{{ $tabel56->id }}" >Hapus</a>
                    </td>
                    </tr>
                                @endforeach
                                <tr>
