...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{url('/tambah-penghitungan-dana-desa')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <thead>
                                ...
                                <?php $i++; 
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit52/'.$tabel52->id) }}" class="btn btn-sm btn-success">Edit</a>
                                        &nbsp
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item">
            <a class="page-link" href="/infrastruktur_pembagian_penetapan_besaran_alokasi_dana_desa" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
