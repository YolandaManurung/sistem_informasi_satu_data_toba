...
class PDAMController extends Controller
{
...

    {
       ...
       //kesehatan jumlah dokter
        ...
        $tbl58a=DB::table('lindup_jenis_perusahaan')->where('status')->get();
        $categories58 = [];
        $data58a = [];
        $data58b = [];
        $data58c = [];
        ...
        $tbl57=DB::table('pdam_jumlah_pemakaian_air_bersih')->paginate(10);
        $tbl57a=DB::table('pdam_jumlah_pemakaian_air_bersih')->where('status', '=', 'Accepted')->get();
        $categories57 =[];
        $data57=[];
        foreach ($tbl57a as $tabel52){
            $categories57[] = $tabel52->pemakaian_air_bersih;
            $data57[] = $tabel52->jumlah;
        ...
        if($request->has('cari')){
            ...
            return view('pages.pdam_jumlah_pemakaian_air_bersih',  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
        ...
        ,'data39','data39a','data39b','data40','data40a','data40b','data36','data36a','data36b','jumlah_panjang_jalan','tbl44c','data43a','data43b','data44c','data44a',
            ...
            'tbl57', 'tbl57a', 'categories57', 'data57'));
        
    }
    public function formulir1(){
        
        return view("pages.formulir-pdam_jumlah_pemakaian_air_bersih");
         
        }
    
        public function tambah1(Request $request)
        {
            Model_PDAM_jumlah_pemakaian_air_bersih::create([
                'pemakaian_air_bersih' => $request->pemakaian_air_bersih,
                'jumlah' => $request->jumlah,
                'tahun'=>$request->tahun]);
            return redirect('/pdam_jumlah_pemakaian_air_bersih');
        }
    
        public function hapus1($id)
        {
            Model_PDAM_jumlah_pemakaian_air_bersih::where('id',$id)->delete();
            return back();
        }
        ...
        {
                $tabel57 =Model_PDAM_jumlah_pemakaian_air_bersih::FindOrFail($id);
                return view('pages.edit.edit-pdam_jumlah_pemakaian_air_bersih',compact('tabel57'));
        }
    
        public function update1(Request $request, $id){
    
            $this->validate($request,[ 
                'pemakaian_air_bersih'=>'required',
                'tahun'=>'required',
                'jumlah'=>'required',
                'status'=>'required',
            ...
            Model_PDAM_jumlah_pemakaian_air_bersih::where('id',$id)->update([
                'pemakaian_air_bersih'=>$input_data['pemakaian_air_bersih'],
                'tahun'=>$input_data['tahun'],
                'jumlah'=>$input_data['jumlah'],
                'status'=>$input_data['status']]);
            return redirect('/pdam_jumlah_pemakaian_air_bersih')->with('message','Data Berhasil Diupdate!!');   
        }
    
        public function exportpdf1()
        {
            $tbl57 = \App\Model_PDAM_jumlah_pemakaian_air_bersih::all()->where('status','=','Accepted');
            $pdf = PDF::loadView('pages.export.export_pdam_jumlah_pemakaian_air_bersih', ['tbl57' => $tbl57]);
            ...
            return $pdf->download('pdam_jumlah_pemakaian_air_bersih.pdf');
        }

    public function pdam1(Request $request)

    {
       ...
       //kesehatan jumlah dokter
        ...
        $jumlah_izin_perusahaan=0;
        foreach ($tbl58 as $tabel52){
            $jumlah_izin_perusahaan+=$tabel52->amdal+$tabel52->ukl_upl+$tabel52->sppl;
        }
        ...
        $tbl57=DB::table('pdam_jumlah_pemakaian_air_bersih')->where('status', '=', 'Accepted')->paginate(10);
        $tbl57a=DB::table('pdam_jumlah_pemakaian_air_bersih')->where('status', '=', 'Accepted')->get();
        $categories57 =[];
        $data57=[];
        foreach ($tbl57a as $tabel52){
        ...
        if($request->has('cari')){
            ...
            return view('PDAM.pdam_jumlah_pemakaian_air_bersih',  compact('tbl1', 'jumlah1', 'i', 'tbl2', 'jumlah2', 'tbl3', 'jumlah3', 'tbl4', 'jumlah4', 'tbl5', 'jumlah5', 'tbl6', 'jumlah6', 'tbl7', 'jumlah7','tbl8', 'jumlah8', 
            'tbl9', 'jumlah9', 'jumlah10', 'jumlah11', 'tbl10', 'tbl11', 'tbl12', 'tbl13', 'tbl14', 'tbl15', 'tbl16', 'tbl17', 'tbl18', 'jumlah12', 'jumlah13', 'jumlah14', 'jumlah15', 
            'jumlah16', 'tbl16a', 'tbl16b', 'tbl16c', 'tbl16d', 'tbl16e', 'tbl16f', 'tbl16g', 'tbl16h', 'tbl16i', 'tbl16j', 'tbl16k', 'tbl16l', 'tbl16m', 'tbl16n', 'tbl16o',
            'jumlah17', 'tbl17a', 'tbl17b', 'tbl17c', 'tbl17d', 'tbl17e', 'tbl17f', 'tbl17g', 'tbl17h', 'tbl17i', 'tbl17j', 'tbl17k', 'tbl17l', 'tbl17m', 'tbl17n', 'tbl17o',
            'jumlah18', 'jumlah19', 'jumlah20', 'jumlah21', 'jumlah22', 'jumlah23', 'jumlah24', 'jumlah25', 'jumlah26', 'jumlah27', 'jumlah28', 'jumlah29', 'jumlah30',
